...
export class ListaComentarioComponent extends React.Component {
    ...
    postComment() {
        ...
        ComentarioApi.add(obj).then((result) => {
    ...
    getComments = async => {
        if (this.props.codigo && this.props.codigo !== "") {
            ...
            ComentarioApi.getAll(this.props.codigo).then((comentarios) => {
                ...
                <div className="row">
                    <div className="offset-md-2 col-md-10">
                        <div className="card">
                            ...
                            {this.state.comentarios && this.state.comentarios.map((c) => (


                                <div key={c.codigo}>
                                    <div className="card">
                                        <div className="card-body">
                                            <p className="card-text"><th>{c.data}</th> {c.texto}</p>
                                        </div>
                                ...
                                <div className="offset-md-3 col-md-9">
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <button className="btn btn-primary" type="button" onClick={(event) => this.postComment()}>Comentar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
